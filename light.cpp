...
//    glfwSetInputMode(window, GLFW_CURSOR, GLFW_CURSOR_DISABLED);
    ...
    // -------------------------
    Shader shader("../res/advancedlight/shadow_mapping.vs", "../res/advancedlight/shadow_mapping.fs");
    Shader simpleDepthShader("../res/advancedlight/shadow_mapping_depth.vs",
                             "../res/advancedlight/shadow_mapping_depth.fs");
    Shader debugDepthQuad("../res/advancedlight/debug_quad.vs", "../res/advancedlight/debug_quad.fs");
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        ImGui::Begin("enable shadow");
        ImGui::Checkbox("enable shadow", &shadows);
        ImGui::End();
